...
class LeadController extends Controller
{
    ...
    public function angi_webhook(Request $request)
    {
        ...
        // dd($data);
        Log::channel('ms_form_amount_not_found')->info($data);
    ...
    public function leads_in_email()
    {
        ...
        foreach($company_emails as $company_email){
            ...
            foreach($messages as $key => $message){
                ...
                foreach($email_found['from_subject'] as $index => $from_subject){
                    if(!is_null(strpos($message->getSubject(), $from_subject))){
                        $email_found = $email_found;
                    }else{
                        continue;
                    }
                }
                // dd($email_found, $message->getSubject());
