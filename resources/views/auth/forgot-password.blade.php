        ...
        <div class="mx-4 mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
                ...
                @if($errors->has('email_not_registered'))
                    <div>
                        <a href="{{ route('registration') }}" type="button" class="flex justify-center w-full px-4 py-2 mt-6 font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm text-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                            Register
                        </a>
                    </div>
                @endif
