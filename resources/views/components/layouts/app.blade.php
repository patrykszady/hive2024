    ...
    <body class="min-h-screen bg-gray-100 dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.item icon="folder" href="/projects">Projects</flux:navlist.item>
                <flux:navlist.item icon="calendar" href="/planner_schedule">Planner</flux:navlist.item>

                @canany(['viewAny', 'create'], App\Models\Expense::class)
                    <flux:navlist.group expandable heading="Expenses" class="hidden lg:grid">
                        <flux:navlist.item href="/expenses" icon="banknotes">Expenses</flux:navlist.item>
                        <flux:navlist.item href="/checks" icon="pencil-square">Checks</flux:navlist.item>
                    </flux:navlist.group>
                @endcanany

                <flux:navlist.item icon="user-group" href="/vendors">Vendors</flux:navlist.item>
                <flux:navlist.item icon="users" href="/clients">Clients</flux:navlist.item>

                <flux:navlist.group expandable heading="Timesheets" class="hidden lg:grid">
                    <flux:navlist.item href="/hours/create" icon="clock">Hours</flux:navlist.item>
                    <flux:navlist.item href="/timesheets" icon="document-currency-dollar">Timesheets</flux:navlist.item>
                    @can('viewPayment', App\Models\Timesheet::class)
                        <flux:navlist.item href="/timesheets/payments" icon="currency-dollar">Payments</flux:navlist.item>
                    @endcan
                </flux:navlist.group>
