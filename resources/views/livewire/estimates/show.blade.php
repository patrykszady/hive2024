                            ...
                            <div class="relative block -ml-px">
                                ...
                                <div
                                    ...
                                    <div class="py-1" role="none">
                                        ...
                                        <a wire:click="print('invoice')" wire:loading.attr="disabled" wire:loading.class="opacity-50" class="block px-4 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-100" role="menuitem" tabindex="-1" id="option-menu-item-2">Export Invoice</a>
