                            ...
                            <div class="relative block -ml-px">
                                ...
                                <div
                                    ...
                                    <div class="py-1" role="none">
                                        ...
                                        {{-- <a wire:click="$dispatchTo('estimates.estimate-duplicate', 'duplicateModal', { estimate: {{$estimate->id}} })" class="block px-4 py-2 text-sm text-gray-700 cursor-pointer hover:bg-gray-100" role="menuitem" tabindex="-1" id="option-menu-item-5">Add To Estimate</a> --}}
