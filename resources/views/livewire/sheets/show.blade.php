<div class="max-w-xl mx-auto space-y-4 sm:px-6">
    ...
    <x-cards accordian="CLOSED">
        ...
        <x-cards.body>
            <x-lists.ul>
                @foreach($general_expense_categories as $category_name => $general_expense_category)
                    <x-lists.search_li
                        :basic=true
                        :bold="TRUE"
                    ...
                    @foreach($general_expense_category->groupBy('vendor.busienss_name') as $vendor_name => $general_expense_vendor_expenses)
                        <x-lists.search_li
                            :basic=true
