<div class="relative overflow-hidden not-prose bg-slate-50 rounded-xl dark:bg-slate-800/25">
    ...
    <div class="relative p-8 overflow-auto rounded-xl">
        <div class="flex items-center justify-center">
            <button type="button" class="inline-flex items-center px-4 py-2 text-sm font-semibold leading-6 text-white transition duration-150 ease-in-out bg-indigo-500 rounded-md shadow cursor-not-allowed hover:bg-indigo-400" disabled="">
